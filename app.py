        ...
        with col2:
            ...
            <div style="text-align: center; padding: 1rem 0 2rem 0;">
                <a href="https://digitalheroesco.com" target="_blank"
                   style="display: inline-block; padding: 0.6rem 1.4rem; margin-bottom: 1rem;
                          background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
                          color: white; text-decoration: none; border-radius: 8px;
                          font-weight: 600; font-size: 0.95rem;">
                    Built for Digital Heroes
                </a>
                <p style="margin: 0.5rem 0 0.25rem 0; color: #666; font-size: 0.9rem;">
                    <strong>Developer:</strong> Ayush
                </p>
                <p style="margin: 0; color: #666; font-size: 0.9rem;">
                    <strong>Email:</strong>
                    <a href="mailto:10323210157@stu.srmuniversity.ac.in" style="color: #667eea; text-decoration: none;">
                        10323210157@stu.srmuniversity.ac.in
                    </a>
                </p>
            </div>
            """, unsafe_allow_html=True)
            ...
            if uploaded_file:
                ...
                if analyze_standard:
                    with st.spinner("Analyzing your document..."):
                        ...
                        validation = self.analyzer.validate_resume(text)
                        if not validation['is_valid']:
                            st.error(f"❌ Invalid File: {validation['message']}")
                            st.warning("Please upload only a valid resume (PDF/DOCX). Marksheets, certificates, invoices, and other non-resume files will not be accepted.")
                            return
